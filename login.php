        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                    <a href="index.php" class="biolife-logo"><img src="assets/images/organic-4.png" alt="biolife logo" width="135" height="34"></a>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 padding-top-2px">
                    ...
                    <div class="live-info">
                        <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b class="phone-number">(+94) 123 456 7891</b></p>
...
<div class="hero-section hero-background">
    <h1 class="page-title">Keells Sri Lanka</h1>
</div>
                    ...
                    <div class="signin-container">
                        <form action="#" name="frm-login" method="post">
                            ...
                            <p class="form-row wrap-btn">
                                <button id="signin-btn" class="btn btn-submit btn-bold" type="submit">Sign In</button>
                    ...
                    <section class="footer-item">
                        ...
                        <div class="footer-phone-info">
                            ...
                            <p class="r-info">
                                ...
                                <span>(0774)  9001-1909  (0774) 689 -66</span>
                            </p>
                        </div>
                            ...
                            <ul class="contact-lines">
                                ...
                                <li>
                                    <p class="info-item">
                                        ...
                                        <b class="desc">Phone: (+94) 234 789  (+94) 222 888</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
                                        <i class="biolife-icon icon-letter"></i>
                                        <b class="desc">Email:  Help@Keells</b>
                                    </p>
                                </li>
                                <li>
                                    <p class="info-item">
